...
const Quizzes = ({
  ...
  return(
    <div className="grid-cols-1 p-8 bg-white text-black flex flex-col text-2xl mx-4 justify-center mt-6 cursor-pointer button-animation" key={quiz.id}>
      ...
      {cookies.get('user').id === quiz.userID && !isHomePage ?
